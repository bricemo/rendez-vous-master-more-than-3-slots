	...
	<script type="text/html" id="tmpl-when">
			...
			<# } else { #>
				<fieldset>
					...
					<div class="daytd">
						<label for="{{data.id}}-hour1"><?php esc_html_e( 'Define 1 to 8 hours for this day, please respect the format HH:MM', 'rendez-vous' );?></label>
						...
						<input type="time" value="{{data.hour4}}" id="{{data.id}}-hour4" placeholder="00:00" class="rdv-input-when">&nbsp;
						<input type="time" value="{{data.hour5}}" id="{{data.id}}-hour5" placeholder="00:00" class="rdv-input-when">&nbsp;
						<input type="time" value="{{data.hour6}}" id="{{data.id}}-hour6" placeholder="00:00" class="rdv-input-when">&nbsp;
						<input type="time" value="{{data.hour7}}" id="{{data.id}}-hour7" placeholder="00:00" class="rdv-input-when">&nbsp
						<input type="time" value="{{data.hour8}}" id="{{data.id}}-hour8" placeholder="00:00" class="rdv-input-when">&nbsp;
					</div>
				</fieldset>
			<# } #>
	</script>
